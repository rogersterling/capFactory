...
from pinecone_plugins.assistant.data.core.client.model.snippet_model import SnippetModel as OpenAPISnippetModel
...
RefType = TypeVar("RefType", bound=Union["TextReference", "PdfReference", "MarkdownReference", "JsonReference"])
